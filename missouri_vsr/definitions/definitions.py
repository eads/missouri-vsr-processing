...
from missouri_vsr.assets import agency_reference, audit, extract, gis, processed, program_287g, reports
...
assets_loaded = load_assets_from_modules(
    [extract, reports, processed, agency_reference, audit, gis, program_287g]
)
